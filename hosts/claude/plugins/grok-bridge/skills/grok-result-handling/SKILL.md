...
description: Use when checking AgentBridge setup, job status, results, or cancellation for Grok Build work started from Claude Code.
---
...
```bash
"$HOME/.agent-bridge/bin/agent-bridge-claude" grok setup --json
