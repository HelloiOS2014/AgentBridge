...
Use the host wrapper (installed by the {{TARGET}}-bridge plugin's self-bootstrap on first use; no manual install command needed). Prefer the absolute path below; do not require the user to export env vars.
