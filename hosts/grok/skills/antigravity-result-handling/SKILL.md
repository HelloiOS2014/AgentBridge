...
description: Use when checking AgentBridge setup, job status, results, or cancellation for Antigravity work started from Grok Build.
---
...
```bash
"$HOME/.agent-bridge/bin/agent-bridge-grok" antigravity setup --json
